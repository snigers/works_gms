									...
									<div class="compare-over-wrapper">
										<div class="compare-wrapper">
											<div class="row">
												<?
												$element_id = "";
												$element_id = getElementIDbyLoc($sectionIdElement, $GEOLOC_BASE_ELEMENT["RATES_BLOCK_ONE_LEFT"]["IBLOCK_ID"]);
												...
												<?
												$element_id = "";
												$element_id = getElementIDbyLoc($sectionIdElement, $GEOLOC_BASE_ELEMENT["RATES_BLOCK_ONE_RIGHT"]["IBLOCK_ID"]);
												$element_id = checkIsArray($element_id);
												?>
												<?$APPLICATION->IncludeComponent(
													"bitrix:news.detail",
